...
public class ParticipantsBean extends BaseBean {
	...
	private int total = 0;
	private int totalWithoutVisitors = 0;
...
//					System.err.println("sending mail to joerg...");
					MailService.sendMail(participant.getEmail(), participant.getFullname(), mailSubject, mailBody, false);
//				}
			} catch(Exception e) {
				System.err.println("Cannot send email to: " + participant.getEmail() + "; " + e.getMessage());
				e.printStackTrace();
			}
			
		}
//		try {
//			MailService.sendMail("bla@blablajoerg.comjoerg", "bla", mailSubject, mailBody, false);
//		} catch(Exception e) {
//			System.err.println("Cannot send email to: " + "bla@blablajoerg.comjoerg");
//		}
	}
	...
	public int getTotalWithoutVisitors() {
		return totalWithoutVisitors;
	}
