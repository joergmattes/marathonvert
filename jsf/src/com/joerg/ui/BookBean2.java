...
public class BookBean2 extends BaseBean {
	...
	private static final Logger log = Logger.getLogger(BookBean2.class.getName());
	...
	public static BookBean2 getBookBean() {
		return (BookBean2) FacesContext.getCurrentInstance().getExternalContext().getSessionMap().get("bookBean2");
	}
...
//	    	List<Participant> partList = (List<Participant>) query.execute(emailSearch1);
	...
	public void sendMail(Participant part, BedPlace bed) {
        try {
        	String subject = "Tango Marathon Vert (" + part.getFullname() + ") --> you've booked your accommodation!";
        	StringBuffer body = new StringBuffer();
        	Util.appendLine(body, "Dear " + part.getFullname() + ",");
        	Util.appendLine(body, "thanks for booking your accommodation. / Merci d'avoir réservé votre hébergement.");
        	...
        	if (StringUtils.equals(BedPlace.TYPE_INDEPENDENT, part.getRoomType())) {
            	Util.appendLine(body, "");
        		Util.appendLine(body, "The price (marathon only, no accommodation) is " + euro + " EUR per person. / Le prix du marathon est de " + euro + " EUR par personne.");
            	...
            	Util.appendLine(body, "");
        		Util.appendLine(body, "The price (marathon and accommodation) is " + euro + " EUR per person. / Le prix (marathon et hébergement) est de " + euro + " euros par personne.");
        		if (bed.isSleepingBag()) {
        			Util.appendLine(body, "Don't forget to bring your camping mat and sleeping bag. / N'oubliez pas votre matelas et votre duvet.");
        		}
        	}
        	...
        	Util.appendLine(body, "");
        	Util.appendLine(body, "Included in the marathon price are two breakfasts, two dinners, as well as fruit and snacks. / Le prix du marathon inclue 2 petits déjeuners, deux diners, ainsi que des fruits et boissons.");
