...
public class BookBean extends BaseBean {
	...
	public void sendMail(Participant part, BedPlace bed) {
        try {
        	...
        	Util.appendLine(body, "");
        	Util.appendLine(body, "Included in the marathon price are two breakfasts, two dinners, as well as fruits, snacks and drinks and perhaps some wine. / Le prix du marathon inclue 2 petits d�jeuners, deux diners, ainsi que des fruits, boissons et peut �tre du vin de la r�gion.");
        	Util.appendLine(body, "");
	...
	public String getPaymentInformation(Participant part) {
		...
		Util.appendLine(payment, "You have time until the 31st may 2016 to pay / Date limite acceptée du paiement le 31 mai 2016.");
		...
		Util.appendLine(payment, "Bank: Soci�t� G�n�rale (33 Av Foch, 69006 Lyon)");
    	...
    	Util.appendLine(payment, "");
    	Util.appendLine(payment, "Alternatively, you can pay " + chf + " CHF to my swiss account / Vous pouvez �galement payer en francs suisse (" + chf + " CHF) sur mon compte suisse suivant:");
